    ...
    <aside class="w-64 bg-purple-700 text-white shadow-lg flex-shrink-0">
      ...
      <nav class="mt-5 overflow-y-auto" style="height: calc(100vh - 160px);">
        ...
        <div class="flex justify-center mb-4 px-4">
          <a href="https://geoportal.sembrandodatos.com/" target="_blank" 
        ...
        <!-- Enlace a Historiales solo visible para administradores -->
        <a href="#" v-if="usuarioActual && usuarioActual.rol === 'admin'" 
           @click="vistaActual = 'historiales'" 
           class="flex items-center px-6 py-3 text-purple-100 transition-colors"
           :class="vistaActual === 'historiales' ? 'bg-purple-800 border-l-4 border-white' : 'hover:bg-purple-800'">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      ...
      <main class="flex-1 overflow-y-auto p-6 bg-gray-50">
        <div class="w-full">
          ...
          <!-- Vista de Historiales - Solo para admins -->
          <HistorialesView v-if="vistaActual === 'historiales'"/>
        </div>
      </main>
