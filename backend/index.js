...
// PUT usuarios - Editar usuario existente (solo para admin)
...
// DELETE usuarios - Eliminar usuario (solo para admin)
...
// ============ ENDPOINTS DE USUARIOS DUPLICADOS CON PREFIJO /api ============

// PUT /api/usuarios/:id - Editar usuario existente (duplicado para producción)
app.put('/api/usuarios/:id', verificarToken, async (req, res) => {
  console.log('=== PUT /api/usuarios/:id (duplicado) ===');
  console.log('ID del usuario:', req.params.id);
  console.log('Usuario autenticado:', req.usuario);
  console.log('Datos recibidos:', req.body);
...
// DELETE /api/usuarios/:id - Eliminar usuario (duplicado para producción)
app.delete('/api/usuarios/:id', verificarToken, async (req, res) => {
  console.log('=== DELETE /api/usuarios/:id (duplicado) ===');
  console.log('ID del usuario:', req.params.id);
  console.log('Usuario autenticado:', req.usuario);
